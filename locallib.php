 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assign_submission_assessmentflags extends assign_submission_plugin {
    ...
    public function get_name() {
        return get_string('pluginname', 'assignsubmission_assessmentflags');
    }
     ...
     * @param bool $showviewlink - If the assessmentflags are long this is
    ...
    /**
     * Always return true because the submission assessmentflags are not part of the submission form.
     *
     * @param stdClass $submission
     * @return bool
     */
    ...
    public function upgrade(context $oldcontext,
        ...
        if ($oldsubmission->data1 != '') {
            ...
            $options = new stdClass();
            $options->area = 'submission_assessmentflags_upgrade';
            $options->course = $this->assignment->get_course();
            $options->context = $this->assignment->get_context();
            $options->itemid = $submission->id;
            $options->component = 'assignsubmission_assessmentflags';
    ...
    /**
     * The submission assessmentflags plugin has no submission component so should not be counted
    ...
    /**
     * Automatically enable or disable this plugin based on "$CFG->assessmentflagsenabled"
     *
     * @return bool
     */
